...
function PromoBranding() {
  ...
  return (
    <section ref={sectionRef} className="py-20 lg:py-32 bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        <div className={`absolute top-1/4 left-1/4 w-64 h-64 bg-violet-500/20 rounded-full blur-3xl transition-all duration-1000 ${visible ? 'opacity-100' : 'opacity-0'}`} />
        <div className={`absolute bottom-1/4 right-1/4 w-80 h-80 bg-fuchsia-500/20 rounded-full blur-3xl transition-all duration-1000 delay-500 ${visible ? 'opacity-100' : 'opacity-0'}`} />
        <div className={`absolute top-1/2 right-1/3 w-48 h-48 bg-emerald-500/20 rounded-full blur-3xl transition-all duration-1000 delay-300 ${visible ? 'opacity-100' : 'opacity-0'}`} />
      </div>
      
      <div className="container-custom relative z-10">
        <div className={`text-center mb-12 lg:mb-16 transition-all duration-700 ${visible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
